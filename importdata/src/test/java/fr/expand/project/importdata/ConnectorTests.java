...
public class ConnectorTests {
	...
	private void testConnector(IConnectorDb connector) {
		...
		objectA.getATTRIBUTES().add(new DataPackAttribute("PRENOM", "Stan"));
		objectA.getATTRIBUTES().add(new DataPackAttribute("NOM", "Marsh"));
		objectA.getATTRIBUTES().add(new DataPackAttribute("TAILLE", "1m20"));
		objectA.getATTRIBUTES().add(new DataPackAttribute("POIDS", "35kg"));
		...
		objectB.getATTRIBUTES().add(new DataPackAttribute("PRENOM", "Eric"));
		objectB.getATTRIBUTES().add(new DataPackAttribute("NOM", "Cartman"));
		objectB.getATTRIBUTES().add(new DataPackAttribute("TAILLE", "1m24"));
		objectB.getATTRIBUTES().add(new DataPackAttribute("POIDS", "65kg"));
